...
CREATE TABLE Cars (
    ...
    CarMPG          FLOAT,
    CarLPer100        FLOAT,
    CarZeroToSixty  FLOAT,
    CarReliability  FLOAT,
    CarWinterCapable VARCHAR(20),
    CarNumberOfSeats INT,
    CarCargoVolume  FLOAT,
    CarGasMultiplier FLOAT,
    CarWeight       INT,
    CarPower        INT,
    CarPWRatio      FLOAT,
...
-- load car data
BULK INSERT Cars
FROM "/tmp/carStats.csv"
WITH (
  FIELDTERMINATOR = ',',  -- Delimiter for the fields (comma in CSV)
  ROWTERMINATOR = '\n',   -- Delimiter for the rows (newline)
